  ...
  return {
    '&&': {
      ...
      color: active
        ...
        : transparentize(theme.base === 'light' ? 0.4 : 0.6, theme.color.defaultText),
...
export type ToggleProps = Omit<HTMLProps<HTMLDivElement>, keyof ToggleOwnProps> & ToggleOwnProps;
